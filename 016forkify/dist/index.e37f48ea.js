...
showRecipe(); // window.location.hash.slice(1) - to check id and remove # from id
 // if we want to add more than one event listner for same fun
 // ['hashchange', 'load'].forEach(ev => window.addEventListener(ev, showRecipe));
 // Guard clause
 // is a way to write cleaner code by handling special cases or errors at the beginning of a function, so the rest of the code can focus on the main task. It helps avoid long and messy if-else blocks.
